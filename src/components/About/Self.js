...
function Self() {
    return (
        <>
            <p>
                I completed my Btech (CSE) from Jaypee Institute Of Technology in 2021. I enjoy solving software problems and knack in web development.Well-qualified Full Stack Developer familiar with
